...
- Validate all constructor arguments. Throw a `TypeError` with a descriptive message for invalid inputs.
...
- Implement proper getters and setters for encapsulation.
- Use readonly properties for immutable fields.

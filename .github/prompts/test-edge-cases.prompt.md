...
agent: tester
argument-hint: Path to the existing test file (e.g., tests/models/draft.test.ts)
---

# Add Edge Case Tests

Review the existing test file the user provides. Add tests for any edge cases not already covered.
...
- Performance boundaries (very large inputs)
